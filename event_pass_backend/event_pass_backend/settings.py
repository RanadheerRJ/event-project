"""
Django settings for event_pass_backend project.
...
SECRET_KEY = 'django-insecure-7c+dzy-#k=0(bfyy@hs$-g-7up%c%39h&)$1^tlc-^=!xja_%p'
...
WSGI_APPLICATION = 'event_pass_backend.wsgi.application'
